...
LeftLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    Left.Size = UDim2.new(0, 282, 0, LeftLayout.AbsoluteContentSize.Y + 20)
end)
...
RightLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    Right.Size = UDim2.new(0, 282, 0, RightLayout.AbsoluteContentSize.Y + 20)
end)
                    ...
                    if type == "Toggle" then
                       ...
                       function element:add_keybind(key_default, key_callback)
                            ...
                            uis.InputBegan:Connect(function(input)
								if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.MouseButton2) and not is_binding then
                            ...
                            uis.InputBegan:Connect(function(input)
                                ...
                                elseif extra_value.Key ~= nil then
                                    ...
                                    if key == extra_value.Key then
                                        ...
                                        if extra_value.Type == "Toggle" then
                                            element:set_value({Toggle = extra_value.Active})
                                        elseif extra_value.Type == "Hold" then
                                            element:set_value({Toggle = true})
                                        end
                                    ...
                                    if key == extra_value.Key then
                                        if extra_value.Type == "Hold" then
                                            extra_value.Active = false
                                                                                        element:set_value({Toggle = false})
                                            key_callback(extra_value)
