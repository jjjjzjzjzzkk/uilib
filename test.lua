function Notify(tt, tx, dur)
 ...
 Notify("ui test", "version 1.0.9", 5)
...
-- Library functions 
    ...
    -- Esp Library Section  
        local MiscOptions = {
            ...
            ["Tool_Text"] = false; 
            ["Tool_Text_Color"] = { Color = rgb(255, 255, 255) };
            ["Tool_Text_Position"] = "Bottom";
            ["Tool_Text_Font"] = "ProggyClean";
            ["Tool_Text_Size"] = 12;
        ...
        function Esp.CreateObject( player, typechar ) -- IMPORTANT! 
            ...
            local Items = Data.Items; do
                ...
                -- Texts
                    ...
                    Items.Tools = Esp:Create( "TextLabel", {
                        FontFace = Fonts.ProggyClean;
                        TextColor3 = rgb(255, 255, 255);
                        BorderColor3 = rgb(0, 0, 0);
                        Parent = Esp.Cache;
            ...
            for _,Data in Esp.Players do
                ...
                -- Texts
                    ...
                    elseif string.match(key, "Distance") then 
                        Text = Items.Distance
                        Match = "Distance"
                    elseif string.match(key, "Tools") then 
                        Text = Items.Tools
                        Match = "Tools"
                    end 
